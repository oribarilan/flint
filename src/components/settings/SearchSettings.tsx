  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.section}>
        <h3 className={styles.sectionTitle}>Search Directories</h3>
        <p className={styles.sectionDescription}>
          Spotlight searches for files within these directories. Apps are always discovered
          system-wide.
        </p>
      ...
      <ResetSection label="Reset search settings to defaults?" onReset={handleResetDefaults} />
    </div>
  );
}
