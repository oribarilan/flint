...
describe("SegmentedControl", () => {
  it("renders all options as radio buttons", () => {
    render(<SegmentedControl options={OPTIONS} value="a" onChange={vi.fn()} ariaLabel="Test" />);
  ...
  it("disables options when disabled flag is set", () => {
    ...
    render(<SegmentedControl options={options} value="on" onChange={vi.fn()} ariaLabel="Test" />);
